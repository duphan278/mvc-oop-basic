                ...
                <div class="col-lg-8">
                    <div class="card shadow-lg border-0">
                        ...
                        <div class="card-body p-4">
                            <form method="post" action="<?= BASE_URL ?>?controller=admin&action=create" enctype="multipart/form-data">
                                <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" id="description" class="form-control" rows="4" placeholder="Mô tả chi tiết về sản phẩm"><?= htmlspecialchars($_POST['description'] ?? '') ?></textarea>
                                </div>
