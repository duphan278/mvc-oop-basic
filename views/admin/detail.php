                        ...
                        <div class="card-body p-4">
                            <div class="row">
                                ...
                                <div class="col-md-4 text-center">
                                    <?php
                                        $adminFallbackRolex = ['https://images.unsplash.com/photo-1523170335258-f5ed11844a49?auto=format&fit=crop&w=900&q=80'];
                                        $productImage = resolveProductImage($product['image'] ?? '', $adminFallbackRolex, (int)($product['id'] ?? 0));
                                    ?>
                                    <div class="mb-3">
                                        <img src="<?= htmlspecialchars($productImage) ?>" alt="<?= htmlspecialchars($product['name']) ?>" class="img-fluid rounded shadow" style="max-width: 200px;" />
                                    </div>
                                </div>
                            </div>
                            <div class="mt-4">
