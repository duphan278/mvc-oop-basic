                                    ...
                                    <?php $stt = 1; foreach ($products as $product): ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <?php $thumbImage = resolveProductImage($product['image'] ?? '', [], (int)($product['id'] ?? 0)); ?>
                                                <?php if ($thumbImage !== ''): ?>
                                                    <img src="<?= htmlspecialchars($thumbImage) ?>" alt="<?= htmlspecialchars($product['name']) ?>" class="img-thumbnail" style="max-width: 80px; max-height: 80px;" />
                                                <?php else: ?>
