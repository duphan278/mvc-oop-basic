                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <?php if (!empty($product['image']) && file_exists(PATH_ROOT . '/uploads/' . $product['image'])): ?>
                            <img src="<?= BASE_URL ?>/uploads/<?= htmlspecialchars($product['image']) ?>" class="card-img-top" alt="<?= htmlspecialchars($product['name']) ?>">
                        <?php else: ?>
                            <img src="<?= BASE_URL ?>/public/images/no-image.svg" class="card-img-top" alt="No image">
                        <?php endif; ?>
                        <div class="card-body">
